...
RED.editor.codeEditor.monaco = (function() {
    ...
    //console.log(JSON.stringify(RED.settings ?? {"Settings" : "Not found"}, null, 4));
    //console.logf(RED.util.get(''))
    if (true) {
        console.log("Loading smartlog typescript definitions");
        knownModules["smartlog"] = {package: "smartlog", module: "smartlog", path: "node-red/smartlog.d.ts" },
        defaultServerSideTypes.push(knownModules["smartlog"]);
    } else {
        console.log("Smartlog disabled")
    }
